...
# Use INTERNAL_DNS_ZONE directly from pipeline (e.g., internal.homnifi.com)
...
# Create compatibility symlinks for Nginx
echo "🔗 Creating Nginx compatibility symlinks..."
