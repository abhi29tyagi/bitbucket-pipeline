...
echo ""
echo "To use the Bitbucket Deployment Variables API:"
echo "1. Set USE_BITBUCKET_DEPLOYMENT_VARS=true"
echo "2. Configure authentication with BITBUCKET_ACCESS_TOKEN (same as PR comment functionality)"
echo "3. Ensure BITBUCKET_WORKSPACE and BITBUCKET_REPO_SLUG are set"
echo "4. Create deployment variables in your repository's deployment environments"
echo ""
